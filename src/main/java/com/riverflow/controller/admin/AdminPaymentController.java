...
public class AdminPaymentController {
        ...
        public ResponseEntity<AdminPaymentResponse> updatePaymentStatus(
                ...
                AdminPaymentResponse payment = adminPaymentService.updatePaymentStatus(
        ...
        public ResponseEntity<byte[]> exportPaymentsCsv(
                ...
                byte[] csvData = adminPaymentService.exportPaymentsAsCsv(search, status, gateway, transferType,
                                startDate,
                                endDate);

                String filename = "payments_" + LocalDate.now().format(DateTimeFormatter.ofPattern("yyyyMMdd"))
                                + ".csv";
        ...
        public ResponseEntity<byte[]> exportPaymentsTxt(
                ...
                byte[] txtData = adminPaymentService.exportPaymentsAsTxt(search, status, gateway, transferType,
                                startDate,
                                endDate);
        ...
        public ResponseEntity<byte[]> exportPaymentsJson(
                ...
                byte[] jsonData = adminPaymentService.exportPaymentsAsJson(search, status, gateway, transferType,
                                startDate,
                                endDate);
