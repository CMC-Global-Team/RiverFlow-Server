...
class AdminUserControllerTest {
    ...
    void getAllUsers_AsAdmin_ReturnsUsers() throws Exception {
        ...
        when(adminUserService.getAllUsers(any(), any(), any(), any(), any(), anyInt(), anyInt()))
                .thenReturn(userPage);
    ...
    void getAllUsers_WithPagination_ReturnsPaginatedUsers() throws Exception {
        ...
        when(adminUserService.getAllUsers(any(), any(), any(), any(), any(), eq(1), eq(5)))
                .thenReturn(userPage);
        ...
        verify(adminUserService).getAllUsers(any(), any(), any(), any(), any(), eq(1), eq(5));
    }
    ...
    void getUserPaymentHistory_ValidUser_ReturnsHistory() throws Exception {
        ...
        Page<PaymentHistoryResponse> paymentPage = new PageImpl<>(paymentList, PageRequest.of(0, 10), paymentList.size());
